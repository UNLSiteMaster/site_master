...
CREATE  TABLE IF NOT EXISTS `site_members` (
  ...
  `verified` ENUM('YES', 'NO') NOT NULL DEFAULT 'YES' COMMENT 'The status of the membership.  This can be pending or approved.  Pending members will have to verify that they have access to the site, or have another member approve them.' ,
