...
CREATE TABLE IF NOT EXISTS `sites` (
  ...
  `gpa` DECIMAL(1,2) NOT NULL DEFAULT 0,
...
CREATE TABLE IF NOT EXISTS `scans` (
  `id` INT NOT NULL AUTO_INCREMENT,
  `sites_id` INT NOT NULL,
  `gpa` DECIMAL(1,2) NOT NULL DEFAULT 0 COMMENT 'the GPA.  This is computed by averaging the numeric value of the scanned_page.grade',
