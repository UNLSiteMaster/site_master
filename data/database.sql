...
CREATE  TABLE IF NOT EXISTS `site_members` (
  ...
  `status` ENUM('PENDING', 'APPROVED') NOT NULL DEFAULT 'PENDING' COMMENT 'The status of the membership.  This can be pending or approved.  Pending members will have to verify that they have access to the site, or have another member approve them.' ,
