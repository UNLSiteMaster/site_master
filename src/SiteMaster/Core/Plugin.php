...
class Plugin extends PluginInterface
{
    ...
    public function onUpdate($previousVersion)
    {
        ...
        if ($previousVersion <= 2017040701) {
            $sql = file_get_contents(Util::getRootDir() . "/data/update-2017050801.sql");
        ...
        if ($previousVersion <= 2017050801) {
            $sql = file_get_contents(Util::getRootDir() . "/data/update-2017051601.sql");
        ...
        if ($previousVersion <= 2017052201) {
            $sql = file_get_contents(Util::getRootDir() . "/data/update-2017052401.sql");
        ...
        if ($previousVersion <= 2017052401) {
            $sql = file_get_contents(Util::getRootDir() . "/data/update-2017053001.sql");
        ...
        if ($previousVersion <= 2017053001) {
            $sql = file_get_contents(Util::getRootDir() . "/data/update-2017053101.sql");
